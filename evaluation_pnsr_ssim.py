...
# 定义 K , disp_focus 以及 image_name 的值
...
for idx_k, K in enumerate(K_values):
    ...
    for idx_d, disp_focus in enumerate(disp_focus_values):
        output_dir = f"./outputs_plus/evaluation/{image_name}"
        ...
        path1 = f'/home/kmxu/Bokehme_plus/outputs_plus/evaluation/{image_name}/K{K}_disp{disp_focus}_bokeh_pred.jpg'
