...
parser.add_argument('--arnet_checkpoint_name',       type=str,   help='path to a checkpoint to load', default='arnet.pth')
...
parser.add_argument('--iunet_checkpoint_name',       type=str,   help='path to a checkpoint to load', default='iunet.pth')
...
#新增image_name参数
parser.add_argument('--image_name',                   type= str, default='277', help='image_name')
